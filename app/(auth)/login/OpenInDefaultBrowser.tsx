...
export default function OpenInDefaultBrowser() {
    ...
    return <div className="flex flex-col items-center space-y-2">
        ...
        <a className="px-4 py-2 flex items-center gap-2 bg-white rounded-md border border-input shadow-sm" target="_blank" href={`googlechrome://laginow.com/login?${searchParams?.toString()}`}>
