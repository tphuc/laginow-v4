...
export default async function Page({ searchParams }) {
    ...
    return <div className='relative w-full max-w-screen-2xl mx-auto grid grid-cols-5 gap-4'>
        <div className="col-span-5 md:col-span-4 w-full  max-w-screen-2xl mx-auto">
            ...
            <br />
            <div className="">
                <h1 className="text-2xl tracking-tight font-heading text-accent-foreground"> Bài viết </h1>
            </div>
            <br />
        ...
        <div className="col-span-5 md:col-span-1 max-w-screen-2xl mx-auto px-4 md:px-0">
            ...
            <div className='space-y-2'>
                <div className="rounded-lg p-6 border space-y-2 bg-gradient-to-r from-teal-600 to-sky-500 text-white text-card-foreground shadow-sm " data-v0-t="card">
