...
async function getLocalJobPosts({ page, productType, take }: { page: number; productType?: string; take: number }) {
...
export default async function Page({searchParams}) {
    ...
    let [sellingPosts] = await Promise.all([
       getLocalJobPosts({page: page, take: 9, productType: productType}),
    ])
