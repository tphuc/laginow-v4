...
export default function PostTypeSection() {
    return <div className="w-full relative mx-auto max-w-screen-2xl grid grid-cols-1 pt-8 md:grid-cols-4 gap-4">
        <Link  href='/bds' className="p-6 bg-background cursor-pointer hover:bg-secondary transition-all text-secondary-foreground flex items-start gap-4  border-purple-500  rounded-lg">
        ...
        <Link href='/mua-ban' className="p-6 bg-background cursor-pointer hover:bg-secondary transition-all text-secondary-foreground flex items-start gap-4  border-yellow-500  rounded-lg">
        ...
        <Link href='/tuyen-dung' className="p-6 bg-background cursor-pointer hover:bg-secondary transition-all text-secondary-foreground flex items-start gap-4  border-cyan-500  rounded-lg">
